...
const EXTRA_CELLS = ['scale_exact', 'ternary32', 'dot32_s8', 'mul_bb', 'add', 'mul', 'div', 'gt', 'umax', 'mux32', 'mux16', 'i2f', 'f2i', 'iadd32', 'bf16', 'clip', 'argmax_bf16', 'quant_s8', 'head_scale', 'sqrt', 'rsqrt', 'exp', 'silu_b', 'ternary32pm', 'tern4', 'sum8', 'mul8', 'sum32'];   // 与权重包同名者为等价再设计的替换版（按名覆盖）
