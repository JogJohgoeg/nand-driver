...
const CODE_FILES = ['core/prep_worker.mjs', 'gen_ir/bits.mjs', 'gen_ir/engine.mjs', 'gen_ir/layer.mjs', 'gen_ir/model.mjs', 'gen_ir/gen_core.mjs', 'exec/layer_pack.mjs', 'exec/gen.mjs', 'exec/mega.mjs', 'exec/layer_exec.mjs', 'core/stream_gen.mjs', 'exec/tool_exec.mjs', 'cells/scale_exact.json', 'cells/ternary32.json', 'cells/dot32_s8.json', 'cells/mul_bb.json', 'cells/add.json', 'cells/mul.json', 'cells/div.json', 'cells/gt.json', 'cells/umax.json', 'cells/mux32.json', 'cells/mux16.json', 'cells/i2f.json', 'cells/f2i.json', 'cells/iadd32.json', 'cells/bf16.json', 'cells/clip.json', 'cells/argmax_bf16.json', 'cells/quant_s8.json', 'cells/head_scale.json', 'cells/sqrt.json', 'cells/rsqrt.json', 'cells/exp.json', 'cells/silu_b.json', 'cells/ternary32pm.json', 'cells/tern4.json', 'cells/sum8.json', 'cells/mul8.json', 'cells/sum32.json', 'cells/facc.json', 'cells/facce.json', 'cells/fix2f.json', 'cells/add_nn.json', 'cells/bmax.json', 'cells/addsel.json', 'cells/facce4.json', 'cells/escmul.json', 'cells/racc4.json'];
// 附加单元：不在权重包里、随代码发布的单元（逐位等价替换，见 cells/*.json 的 semantics / replaces）。加载后作为一个虚拟权重块挂进内存中的清单。
const EXTRA_CELLS = ['scale_exact', 'ternary32', 'dot32_s8', 'mul_bb', 'add', 'mul', 'div', 'gt', 'umax', 'mux32', 'mux16', 'i2f', 'f2i', 'iadd32', 'bf16', 'clip', 'argmax_bf16', 'quant_s8', 'head_scale', 'sqrt', 'rsqrt', 'exp', 'silu_b', 'ternary32pm', 'tern4', 'sum8', 'mul8', 'sum32', 'facc', 'facce', 'fix2f', 'add_nn', 'bmax', 'addsel', 'facce4', 'escmul', 'racc4'];   // 与权重包同名者为等价再设计的替换版（按名覆盖）
